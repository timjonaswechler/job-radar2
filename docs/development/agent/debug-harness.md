...
The debug harness is a line-based caller of the public Rust Agent Conversation and authentication interfaces. It is a development tool, not a Tauri command or product UI.
