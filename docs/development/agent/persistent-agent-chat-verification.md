...
| Portable tests, supported-host persistence contracts, and desktop packaging | [`desktop-build` matrix run 30558129421](https://github.com/timjonaswechler/job-radar2/actions/runs/30558129421) ran provider-neutral Agent and frontend gates plus all native bundles; persistence-backed Agent/Tauri contracts ran on macOS and Linux pending #294 | CI | macOS, Windows, Linux | Pass on 2026-07-30 |
