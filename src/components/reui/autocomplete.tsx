...
const inputVariants = cva(
  "outline-none flex w-full text-foreground placeholder:text-muted-foreground disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 [[readonly]]:bg-muted/80 [[readonly]]:cursor-not-allowed border border-input focus-visible:border-ring aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive dark:aria-invalid:border-destructive/50 rounded-md bg-input/20 dark:bg-input/30 text-xs/relaxed transition-colors focus-visible:ring-ring/30 focus-visible:ring-2 aria-invalid:ring-2",
  {
    variants: {
      size: {
...
function AutocompleteStatus({
  ...
  return (
    <AutocompletePrimitive.Status
      ...
      className={cn(
        "text-muted-foreground px-2 py-1 text-xs/relaxed empty:m-0 empty:p-0",
        className
      )}
      {...props}
    />
...
function AutocompleteEmpty({
  ...
  return (
    <AutocompletePrimitive.Empty
      ...
      className={cn(
        "text-muted-foreground px-2 py-1 text-xs/relaxed text-center empty:m-0 empty:p-0",
        className
      )}
      {...props}
    />
