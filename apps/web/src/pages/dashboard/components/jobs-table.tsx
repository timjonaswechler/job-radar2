...
import { recentOrdersColumns } from "./jobs-table/columns"
import recentOrdersData from "./jobs-table/data.json"
import {
  formatOrderCount,
  formatSelectedOrderCount,
  preventPaginationNavigation,
} from "./jobs-table/formatters"
import {
  type OrderFilter,
  type OrderRow,
  orderFilters,
} from "./jobs-table/schema"
...
export function RecentOrders() {
  ...
  const statusSummaryFilter = table
    .getColumn("statusSummary")
    ?.getFilterValue()
  const activeFilter =
    typeof statusSummaryFilter === "string" &&
    orderFilters.includes(statusSummaryFilter as OrderFilter)
      ? (statusSummaryFilter as OrderFilter)
      : "All"
        ...
        <div className="flex items-center justify-between px-4">
          <ToggleGroup
            ...
            onValueChange={(values) => {
              const value = values[0] as OrderFilter | undefined
              if (!value) return
              table
                .getColumn("statusSummary")
