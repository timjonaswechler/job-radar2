...
function formatDatabaseInitializedAt(value: string | null) {
  if (!value) return "Initialisierungszeit unbekannt."

  return `Datenbank initialisiert: ${new Intl.DateTimeFormat("de", {
    dateStyle: "medium",
    timeStyle: "short",
...
export function AppNotifications() {
        ...
        toast.custom(
          () => (
            <SuccessToast
              ...
              description={formatDatabaseInitializedAt(info.initializedAt)}
            />
          ),
  ...
  return <Toaster closeButton position="bottom-right" />
}
