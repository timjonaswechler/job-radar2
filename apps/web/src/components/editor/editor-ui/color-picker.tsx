...
type SlotPrimitiveProps = {
  children?: React.ReactNode;
  [key: string]: unknown;
};

const SlotPrimitive = React.forwardRef<HTMLElement, SlotPrimitiveProps>(
  function SlotPrimitive({ children, ...slotProps }, forwardedRef) {
    ...
    const mergedProps = mergeProps(
      slotProps as React.ComponentPropsWithRef<"div">,
