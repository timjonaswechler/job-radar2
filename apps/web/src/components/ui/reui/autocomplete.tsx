...
const inputVariants = cva(
  "flex w-full rounded-md border border-input bg-input/20 text-xs/relaxed text-foreground transition-colors outline-none placeholder:text-muted-foreground focus-visible:border-ring focus-visible:ring-2 focus-visible:ring-ring/30 disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-2 aria-invalid:ring-destructive/20 dark:bg-input/30 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [[readonly]]:cursor-not-allowed [[readonly]]:bg-muted/80",
  {
    variants: {
      size: {
        sm: "h-6 px-2 [&~[data-slot=autocomplete-clear]]:end-1.25 [&~[data-slot=autocomplete-trigger]]:end-1.25",
        default:
          "h-7 px-2 [&~[data-slot=autocomplete-clear]]:end-1.5 [&~[data-slot=autocomplete-trigger]]:end-1.5",
        lg: "h-8 px-2.5 [&~[data-slot=autocomplete-clear]]:end-1.75 [&~[data-slot=autocomplete-trigger]]:end-1.75",
      },
    },
    defaultVariants: {
      size: "default",
...
function AutocompleteStatus({
  ...
  return (
    <AutocompletePrimitive.Status
      ...
      className={cn(
        "px-2 py-1 text-xs/relaxed text-muted-foreground empty:m-0 empty:p-0",
        className
      )}
      {...props}
    />
...
function AutocompleteItem({
  ...
  return (
    <AutocompletePrimitive.Item
      ...
      className={cn(
        "relative flex cursor-default items-center gap-2 rounded-md px-2 py-1 text-xs/relaxed text-foreground outline-hidden transition-colors select-none data-highlighted:relative data-highlighted:z-0 data-highlighted:text-foreground data-highlighted:before:absolute data-highlighted:before:inset-x-0 data-highlighted:before:inset-y-0 data-highlighted:before:z-[-1] data-highlighted:before:rounded-sm data-highlighted:before:bg-accent data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-3.5 [&_svg:not([role=img]):not([class*=text-])]:opacity-60",
        className
      )}
      {...props}
    />
...
function AutocompleteEmpty({
  ...
  return (
    <AutocompletePrimitive.Empty
      ...
      className={cn(
        "px-2 py-1 text-center text-xs/relaxed text-muted-foreground empty:m-0 empty:p-0",
        className
      )}
      {...props}
    />
