...
fn production_completeness_policy(_compiled: &[CompiledRegistration]) -> CompletenessPolicy {
    ...
    let canonical_files = BTreeMap::from([
        (
            Owner::P01,
            BTreeSet::from(["src-tauri/src/profile_dsl/template.rs".to_owned()]),
        ),
        (
            Owner::P02,
            BTreeSet::from([
                "src-tauri/src/profile_dsl/primitives/parse/html.rs".to_owned(),
                "src-tauri/src/profile_dsl/primitives/parse/json.rs".to_owned(),
                "src-tauri/src/profile_dsl/primitives/parse/mod.rs".to_owned(),
                "src-tauri/src/profile_dsl/primitives/parse/xml.rs".to_owned(),
            ]),
        ),
        (
            Owner::P03,
            BTreeSet::from([
                "src-tauri/src/profile_dsl/primitives/select/css.rs".to_owned(),
                "src-tauri/src/profile_dsl/primitives/select/document.rs".to_owned(),
                "src-tauri/src/profile_dsl/primitives/select/json_path.rs".to_owned(),
                "src-tauri/src/profile_dsl/primitives/select/sitemap_urls.rs".to_owned(),
                "src-tauri/src/profile_dsl/primitives/select/xml_element.rs".to_owned(),
                "src-tauri/src/profile_dsl/primitives/select/xml_text.rs".to_owned(),
            ]),
        ),
        (
            Owner::P04,
            BTreeSet::from([
                "src-tauri/src/profile_dsl/primitives/cardinality/all.rs".to_owned(),
                "src-tauri/src/profile_dsl/primitives/cardinality/first.rs".to_owned(),
                "src-tauri/src/profile_dsl/primitives/cardinality/one.rs".to_owned(),
                "src-tauri/src/profile_dsl/primitives/cardinality/optional.rs".to_owned(),
            ]),
        ),
        (
            Owner::P05,
            BTreeSet::from([
                "src-tauri/src/profile_dsl/primitives/transform/dedupe.rs".to_owned(),
                "src-tauri/src/profile_dsl/primitives/transform/html_to_text.rs".to_owned(),
                "src-tauri/src/profile_dsl/primitives/transform/join.rs".to_owned(),
                "src-tauri/src/profile_dsl/primitives/transform/normalize_whitespace.rs".to_owned(),
                "src-tauri/src/profile_dsl/primitives/transform/regex_replace.rs".to_owned(),
                "src-tauri/src/profile_dsl/primitives/transform/slug_to_title.rs".to_owned(),
                "src-tauri/src/profile_dsl/primitives/transform/split.rs".to_owned(),
                "src-tauri/src/profile_dsl/primitives/transform/to_string.rs".to_owned(),
                "src-tauri/src/profile_dsl/primitives/transform/trim.rs".to_owned(),
                "src-tauri/src/profile_dsl/primitives/transform/url_decode.rs".to_owned(),
            ]),
        ),
        (
            Owner::P06a,
            BTreeSet::from(["src-tauri/src/profile_dsl/primitives/value/mod.rs".to_owned()]),
        ),
        (
            Owner::P06bc,
            BTreeSet::from([
                "src-tauri/src/profile_dsl/primitives/value/capture.rs".to_owned(),
                "src-tauri/src/profile_dsl/primitives/value/combine.rs".to_owned(),
                "src-tauri/src/profile_dsl/primitives/value/const_value.rs".to_owned(),
                "src-tauri/src/profile_dsl/primitives/value/css_attribute.rs".to_owned(),
                "src-tauri/src/profile_dsl/primitives/value/css_text.rs".to_owned(),
                "src-tauri/src/profile_dsl/primitives/value/first_non_empty.rs".to_owned(),
                "src-tauri/src/profile_dsl/primitives/value/item_field.rs".to_owned(),
                "src-tauri/src/profile_dsl/primitives/value/json_path.rs".to_owned(),
                "src-tauri/src/profile_dsl/primitives/value/mod.rs".to_owned(),
                "src-tauri/src/profile_dsl/primitives/value/posting_meta.rs".to_owned(),
                "src-tauri/src/profile_dsl/primitives/value/source_config.rs".to_owned(),
                "src-tauri/src/profile_dsl/primitives/value/template.rs".to_owned(),
                "src-tauri/src/profile_dsl/primitives/value/xml_element.rs".to_owned(),
                "src-tauri/src/profile_dsl/primitives/value/xml_text.rs".to_owned(),
            ]),
        ),
        (
            Owner::P07,
            BTreeSet::from([
                "src-tauri/src/profile_dsl/primitives/predicate/equal.rs".to_owned(),
                "src-tauri/src/profile_dsl/primitives/predicate/mod.rs".to_owned(),
                "src-tauri/src/profile_dsl/primitives/predicate/non_empty.rs".to_owned(),
                "src-tauri/src/profile_dsl/primitives/predicate/regex.rs".to_owned(),
            ]),
        ),
        (
            Owner::P08,
            BTreeSet::from(["src-tauri/src/profile_dsl/primitives/capture/named.rs".to_owned()]),
        ),
        (
            Owner::P09,
            BTreeSet::from(["src-tauri/src/profile_dsl/primitives/fetch/http.rs".to_owned()]),
        ),
        (
            Owner::P10,
            BTreeSet::from(["src-tauri/src/profile_dsl/primitives/pagination/mod.rs".to_owned()]),
        ),
        (
            Owner::P11,
            BTreeSet::from(["src-tauri/src/profile_dsl/primitives/acceptance/mod.rs".to_owned()]),
        ),
        (
            Owner::B01,
            BTreeSet::from(["src-tauri/src/profile_dsl/documents/limits.rs".to_owned()]),
        ),
        (
            Owner::B03a,
            BTreeSet::from(["src-tauri/src/profile_dsl/primitives/fetch/browser.rs".to_owned()]),
        ),
        (
            Owner::D02,
            BTreeSet::from(["src-tauri/src/source_profile/detection/strategy.rs".to_owned()]),
        ),
        (
            Owner::D03,
            BTreeSet::from(["src-tauri/src/source_profile/detection/strategy.rs".to_owned()]),
