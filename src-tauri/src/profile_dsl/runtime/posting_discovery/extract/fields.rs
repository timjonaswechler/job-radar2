...
pub(in crate::profile_dsl::runtime::posting_discovery) struct FieldEvaluation {
    pub(in crate::profile_dsl::runtime::posting_discovery) value: Option<String>,
    pub(in crate::profile_dsl::runtime::posting_discovery) failed: bool,
}

pub(in crate::profile_dsl::runtime::posting_discovery) fn evaluate_string_field(
...
pub(in crate::profile_dsl::runtime::posting_discovery) struct RawFieldValues<'a> {
    pub(in crate::profile_dsl::runtime::posting_discovery) values: Vec<String>,
    pub(in crate::profile_dsl::runtime::posting_discovery) failed: bool,
    pub(in crate::profile_dsl::runtime::posting_discovery) cardinality: Option<Cardinality>,
    pub(in crate::profile_dsl::runtime::posting_discovery) transforms: Option<&'a Vec<Transform>>,
}

pub(in crate::profile_dsl::runtime::posting_discovery) fn raw_field_values<'a>(
    item: &RuntimeItem<'_, '_>,
    source_config: &SourceConfig,
    source_name: &str,
    captures: &BTreeMap<String, String>,
...
pub(in crate::profile_dsl::runtime::posting_discovery) fn apply_transforms(
    values: Vec<String>,
