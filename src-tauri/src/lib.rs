...
pub use checks::{
    ...
    source_profile_verification_report_status, verify_source_profile, CheckFingerprint,
    CheckReport, CheckReportFreshness, CheckReportFreshnessState, CheckReportKind,
    CheckReportPersistenceError, CheckReportResult, CheckReportStaleDetail, CheckReportStaleReason,
    CheckReportSubject, CheckReportSubjectType, EffectiveVerificationState, FixtureManifest,
    FixtureManifestChecks, FixtureManifestDiscoveryExpect, FixtureManifestExpectedCandidate,
    ...
    FixturePathResolution, SourceProfileVerificationReportState,
    SourceProfileVerificationReportStatus, CHECK_REPORT_SCHEMA_VERSION,
    DEFAULT_FIXTURE_MANIFEST_REFERENCE, FIXTURE_MANIFEST_SCHEMA_VERSION,
    PROFILE_VERIFICATION_LOGIC_VERSION, SOURCE_LIVE_CHECK_LOGIC_VERSION,
