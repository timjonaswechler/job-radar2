...
pub(in crate::source::detection) struct DetectionTemplateContext<'a> {
    pub(in crate::source::detection) input_url: &'a Url,
    pub(in crate::source::detection) captures: &'a HashMap<String, String>,
}
