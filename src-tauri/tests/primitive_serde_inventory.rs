use job_radar_lib::{
    production_schema_inventory, production_serde_inventory, Acceptance, AuthoredShapeKind,
    BrowserInteraction, BrowserWait, CaptureRule, DetectionStrategy, DetectionUrlInput, Family,
