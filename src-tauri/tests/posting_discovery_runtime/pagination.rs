...
#[test]
fn compiled_posting_discovery_runtime_executes_bounded_page_pagination() {
...
#[test]
fn compiled_posting_discovery_runtime_reports_max_requests_limit() {
    let plan = compiled_posting_discovery_plan_with_strategy(
        json!({ "type": "json" }),
        default_select(),
        default_fields(),
...
#[test]
fn compiled_posting_discovery_runtime_stops_page_pagination_when_total_path_is_exhausted() {
    let plan = compiled_posting_discovery_plan_with_strategy(
        json!({ "type": "json" }),
        default_select(),
        default_fields(),
...
#[test]
fn compiled_posting_discovery_runtime_reports_max_items_limit() {
    let plan = compiled_posting_discovery_plan_with_strategy(
        json!({ "type": "json" }),
        default_select(),
        default_fields(),
...
#[test]
fn compiled_posting_discovery_runtime_stops_offset_limit_pagination_when_total_path_is_exhausted() {
    let plan = compiled_posting_discovery_plan_with_strategy(
        json!({ "type": "json" }),
        default_select(),
        default_fields(),
...
#[test]
fn compiled_posting_discovery_runtime_extracts_posting_urls_from_sitemap_xml() {
    let plan = compiled_posting_discovery_plan_with_strategy(
        json!({ "type": "xml" }),
        json!({ "type": "document" }),
        json!({
...
#[test]
fn compiled_posting_discovery_runtime_follows_child_sitemaps_within_max_depth() {
    let plan = compiled_posting_discovery_plan_with_strategy(
        json!({ "type": "xml" }),
        json!({ "type": "document" }),
        json!({
...
#[test]
fn compiled_posting_discovery_runtime_reports_sitemap_max_depth_limit() {
    let plan = compiled_posting_discovery_plan_with_strategy(
        json!({ "type": "xml" }),
        json!({ "type": "document" }),
        json!({
...
#[test]
fn compiled_posting_discovery_runtime_reports_sitemap_max_requests_limit() {
    let plan = compiled_posting_discovery_plan_with_strategy(
        json!({ "type": "xml" }),
        json!({ "type": "document" }),
        json!({
...
#[test]
fn compiled_posting_discovery_runtime_executes_bounded_offset_limit_pagination() {
    let plan = compiled_posting_discovery_plan_with_strategy(
        json!({ "type": "json" }),
        default_select(),
        default_fields(),
