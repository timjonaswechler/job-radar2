...
#[test]
fn compiled_posting_discovery_runtime_posts_rendered_json_body_and_public_headers() {
...
#[test]
fn compiled_posting_discovery_runtime_posts_rendered_text_body() {
    let mut extra = serde_json::Map::new();
    extra.insert(
        "fetch".to_string(),
        json!({
...
#[test]
fn compiled_posting_discovery_runtime_reports_body_template_rendering_failure() {
...
#[test]
fn compiled_posting_discovery_runtime_reports_get_body_combination() {
    let mut extra = serde_json::Map::new();
    extra.insert(
        "fetch".to_string(),
        json!({
...
#[test]
fn compiled_posting_discovery_runtime_posts_rendered_form_body() {
    let mut extra = serde_json::Map::new();
    extra.insert(
        "fetch".to_string(),
        json!({
