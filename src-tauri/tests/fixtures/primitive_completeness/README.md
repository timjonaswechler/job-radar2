...
```bash
cargo test --manifest-path src-tauri/Cargo.toml --test primitive_schema_inventory
cargo test --manifest-path src-tauri/Cargo.toml --test primitive_serde_inventory
cargo test --manifest-path src-tauri/Cargo.toml --test primitive_compiled_registration_parity
cargo test --manifest-path src-tauri/Cargo.toml --test primitive_registry_structure
