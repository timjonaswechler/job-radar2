...
fn sitemap_fan_out_plan() -> source_profile_dsl::SourceExecutionPlan {
...
fn plan() -> source_profile_dsl::SourceExecutionPlan {
...
fn compile_plan(
...
) -> source_profile_dsl::SourceExecutionPlan {
    ...
    match source_profile_dsl::compile_source(&source, &registry) {
