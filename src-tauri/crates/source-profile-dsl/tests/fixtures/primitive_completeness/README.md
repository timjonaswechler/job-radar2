...
```bash
just rust-crate-test source-profile-dsl primitives schema_inventory::
just rust-crate-test source-profile-dsl primitives serde_inventory::
just rust-crate-test source-profile-dsl primitives compiled_registration::
just rust-crate-test source-profile-dsl primitives registry_structure::
