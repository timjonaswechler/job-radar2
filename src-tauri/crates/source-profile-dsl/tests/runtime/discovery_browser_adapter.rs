...
use source_profile_dsl::{
    ...
    BrowserAcquisitionRequestSnapshot, CompileSourceOutcome, DiscoveryBrowserAdapter,
    ExecutionPlanBrowserInteraction, ExecutionPlanBrowserWait, PhaseBrowser, PhaseCompletion,
