...
fn compiled_source(strategies: Vec<Value>) -> source_profile_dsl::test_support::CompiledSource {
...
fn compiled_source_with_policy(
    ...
    policy: Value,
) -> source_profile_dsl::test_support::CompiledSource {
...
) -> source_profile_dsl::test_support::PostingOccurrence {
