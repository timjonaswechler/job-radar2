...
use source_profile_dsl::test_support::{
    compile_source, execute_detail, AllowanceDimension, AllowanceExhaustion, AllowanceLimitSource,
    BrowserAcquisitionFailure, BrowserAcquisitionFailureKind, BrowserAcquisitionRequestSnapshot,
    BrowserInteractionInstruction, BrowserWaitInstruction, CompileSourceOutcome,
    DetailBrowserAdapter, DetailField, PhaseBrowser, PhaseCompletion, PhaseExecutionFailure,
