...
pub fn completeness_serde_shapes() -> Vec<crate::profile_dsl::primitives::completeness::SerdeShape>
{
    ...
    vec![
        serde_shape(
            ...
            &[Discovery, Detail],
            ParentOption,
            "src-tauri/crates/source-profile-dsl/src/profile_dsl/documents/strategy.rs",
        ),
        serde_shape(
            Acceptance,
...
pub fn completeness_compiled_registrations(
    ...
    vec![
        CompiledRegistration {
            ...
            owner: P11,
            canonical_file:
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/acceptance/mod.rs",
            shape: ParentOption,
