...
pub fn compile(text_path: &str) -> Result<XmlTextSelectPlan, String> {
...
pub fn path_texts(node: roxmltree::Node<'_, '_>, text_path: &str) -> Vec<String> {
...
pub fn node_text(node: roxmltree::Node<'_, '_>) -> String {
    node.descendants()
