    ...
    let mut out = fixtures
        ...
        .map(|value| {
            ...
            serde_shape(
                ...
                &[Discovery, Detail],
                Tagged,
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/documents/parse.rs",
            )
        })
        .collect::<Vec<_>>();
...
pub fn completeness_compiled_registrations(
    ...
    vec![
        CompiledRegistration {
            ...
            owner: P02,
            canonical_file:
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/parse/json.rs",
            shape: Tagged,
        ...
        CompiledRegistration {
            ...
            owner: P02,
            canonical_file:
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/parse/xml.rs",
            shape: Tagged,
        ...
        CompiledRegistration {
            ...
            owner: P02,
            canonical_file:
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/parse/html.rs",
            shape: Tagged,
