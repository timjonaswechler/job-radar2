...
pub fn completeness_serde_shapes() -> Vec<crate::profile_dsl::primitives::completeness::SerdeShape>
{
    ...
    for descriptor in pagination_descriptors() {
        out.push(serde_shape(
            ...
            &[Discovery],
            Tagged,
            "src-tauri/crates/source-profile-dsl/src/profile_dsl/documents/pagination.rs",
        ));
...
pub fn completeness_compiled_registrations(
    ...
    macro_rules! row {
        ($key:literal,$shape:expr,$identity:literal,$witness:expr) => {
            CompiledRegistration {
                ...
                contexts: &[Discovery],
                owner: P10,
                canonical_file: "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/pagination/mod.rs",
                shape: $shape,
    ...
    vec![
        ...
        CompiledRegistration {
            ...
            owner: P10,
            canonical_file:
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/pagination/mod.rs",
            shape: Tagged,
