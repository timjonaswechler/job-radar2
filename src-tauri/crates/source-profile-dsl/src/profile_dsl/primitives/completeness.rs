//! Implementation-free global Profile DSL completeness gate.
//!
...
fn production_completeness_policy(_compiled: &[CompiledRegistration]) -> CompletenessPolicy {
    ...
    let canonical_files = BTreeMap::from([
        (
            Owner::P01,
            BTreeSet::from(["src-tauri/crates/source-profile-dsl/src/profile_dsl/template.rs".to_owned()]),
        ),
        (
            Owner::P02,
            BTreeSet::from([
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/parse/html.rs".to_owned(),
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/parse/json.rs".to_owned(),
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/parse/mod.rs".to_owned(),
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/parse/xml.rs".to_owned(),
            ]),
        ),
        (
            Owner::P03,
            BTreeSet::from([
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/select/css.rs".to_owned(),
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/select/document.rs".to_owned(),
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/select/json_path.rs".to_owned(),
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/select/sitemap_urls.rs".to_owned(),
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/select/xml_element.rs".to_owned(),
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/select/xml_text.rs".to_owned(),
            ]),
        ),
        (
            Owner::P04,
            BTreeSet::from([
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/cardinality/all.rs".to_owned(),
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/cardinality/first.rs".to_owned(),
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/cardinality/one.rs".to_owned(),
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/cardinality/optional.rs".to_owned(),
            ]),
        ),
        (
            Owner::P05,
            BTreeSet::from([
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/transform/dedupe.rs".to_owned(),
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/transform/html_to_text.rs".to_owned(),
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/transform/join.rs".to_owned(),
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/transform/normalize_whitespace.rs".to_owned(),
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/transform/regex_replace.rs".to_owned(),
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/transform/slug_to_title.rs".to_owned(),
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/transform/split.rs".to_owned(),
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/transform/to_string.rs".to_owned(),
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/transform/trim.rs".to_owned(),
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/transform/url_decode.rs".to_owned(),
            ]),
        ),
        (
            Owner::P06a,
            BTreeSet::from(["src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/value/mod.rs".to_owned()]),
        ),
        (
            Owner::P06bc,
            BTreeSet::from([
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/value/capture.rs".to_owned(),
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/value/combine.rs".to_owned(),
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/value/const_value.rs".to_owned(),
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/value/css_attribute.rs".to_owned(),
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/value/css_text.rs".to_owned(),
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/value/first_non_empty.rs".to_owned(),
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/value/item_field.rs".to_owned(),
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/value/json_path.rs".to_owned(),
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/value/mod.rs".to_owned(),
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/value/posting_meta.rs".to_owned(),
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/value/source_config.rs".to_owned(),
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/value/template.rs".to_owned(),
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/value/xml_element.rs".to_owned(),
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/value/xml_text.rs".to_owned(),
            ]),
        ),
        (
            Owner::P07,
            BTreeSet::from([
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/predicate/equal.rs".to_owned(),
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/predicate/mod.rs".to_owned(),
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/predicate/non_empty.rs".to_owned(),
                "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/predicate/regex.rs".to_owned(),
            ]),
        ),
        (
            Owner::P08,
            BTreeSet::from(["src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/capture/named.rs".to_owned()]),
        ),
        (
            Owner::P09,
            BTreeSet::from(["src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/fetch/http.rs".to_owned()]),
        ),
        (
            Owner::P10,
            BTreeSet::from(["src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/pagination/mod.rs".to_owned()]),
        ),
        (
            Owner::P11,
            BTreeSet::from(["src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/acceptance/mod.rs".to_owned()]),
        ),
        (
            Owner::B01,
            BTreeSet::from(["src-tauri/crates/source-profile-dsl/src/profile_dsl/documents/limits.rs".to_owned()]),
        ),
        (
            Owner::B03a,
            BTreeSet::from(["src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/fetch/browser.rs".to_owned()]),
        ),
        (
            Owner::D02,
            BTreeSet::from(["src-tauri/crates/source-profile-dsl/src/source_profile/detection/plan.rs".to_owned()]),
        ),
        (
            Owner::D03,
            BTreeSet::from(["src-tauri/crates/source-profile-dsl/src/source_profile/detection/plan.rs".to_owned()]),
...
pub fn production_serde_inventory() -> Vec<SerdeShape> {
    ...
    values.extend(crate::profile_dsl::template::completeness_serde_shapes());
    ...
    values.extend(crate::profile_dsl::documents::fetch::completeness_serde_shapes());
    values.extend(super::pagination::completeness_serde_shapes());
    values.extend(super::acceptance::completeness_serde_shapes());
    values.extend(crate::profile_dsl::documents::detection::completeness_serde_shapes());
    values.extend(crate::profile_dsl::documents::limits::completeness_serde_shapes());
    values.sort();
    values
}
pub fn production_compiled_inventory() -> Vec<CompiledRegistration> {
    let mut values = Vec::new();
    values.extend(crate::profile_dsl::template::completeness_compiled_registrations());
    ...
    values.extend(crate::source_profile::detection::completeness_compiled_registrations());
    values.extend(crate::profile_dsl::documents::limits::completeness_compiled_registrations());
    values.sort();
    values
}
...
pub fn schema_inventory_from_documents(docs: BTreeMap<String, Value>) -> Vec<SchemaShape> {
    ...
    option_shape(
        ...
        "profile-dsl/parse.schema.json#/$defs/parse/properties/charset",
    );
    variant_shapes(
        &docs,
        &mut out,
    ...
    singleton(
        ...
        "profile-dsl/extract.schema.json#/$defs/listFieldExpression/oneOf/0",
    );
    singleton(
        &mut out,
        Family::Value,
        ...
        list_contexts,
        AuthoredShapeKind::Untagged,
        "profile-dsl/extract.schema.json#/$defs/listFieldExpression/oneOf/1",
    );
    object_options(
        &docs,
        &mut out,
    ...
    option_shape(
        ...
        value_contexts,
        AuthoredShapeKind::ParentOption,
        "profile-dsl/extract.schema.json#/$defs/combineExpression/properties/join",
    );
    option_shape(
        &mut out,
        Family::Value,
        ...
        value_contexts,
        AuthoredShapeKind::ParentOption,
        "profile-dsl/extract.schema.json#/$defs/firstNonEmptyExpression/properties/candidates",
    );
    for context in value_contexts {
        singleton(
            ...
            &[*context],
            AuthoredShapeKind::ParentOption,
            "profile-dsl/extract.schema.json#/$defs/fieldExpression",
        );
    }
    ...
    singleton(
        ...
        "profile-dsl/select.schema.json#/$defs/captures",
    );
    object_options(
        &docs,
        &mut out,
    ...
    singleton(
        ...
        AuthoredShapeKind::Keyed,
        "profile-dsl/common.schema.json#/$defs/templateString",
    );
    option_shape(
        &mut out,
        Family::PhaseLimit,
        ...
        AuthoredShapeKind::ParentOption,
        "profile-dsl/policy.schema.json#/$defs/phaseLimits/properties/maxBrowserRenderedBytes",
    );
...
fn schema_occurrences(
    ...
    if family == Family::Value && matches!(key, "list.single" | "list.multiple") {
        return match context {
            DiscoveryFilterOutput => &["profile-dsl/strategy.schema.json#/$defs/discoveryExtraction/properties/providerValues/properties/locations"],
            DetailMatchFilterOutput => &["profile-dsl/strategy.schema.json#/$defs/detailExtraction/properties/fields/properties/locations"],
            _ => &[],
        };
    }
    match context {
        ...
        DiscoveryValue => {
            &["profile-dsl/strategy.schema.json#/$defs/discoveryStrategy/properties/extract"]
        }
        DetailValue => {
            &["profile-dsl/strategy.schema.json#/$defs/detailStrategy/properties/extract"]
        }
        DiscoveryHttpUrl | DetailHttpUrl => {
            &["profile-dsl/fetch.schema.json#/$defs/httpFetch/properties/url"]
        }
        DiscoveryHttpHeader | DetailHttpHeader => {
            &["profile-dsl/fetch.schema.json#/$defs/httpFetch/properties/headers"]
        }
        DiscoveryHttpBody | DetailHttpBody => {
            &["profile-dsl/fetch.schema.json#/$defs/httpFetch/properties/body"]
        }
        DiscoveryBrowserUrl | DetailBrowserUrl => {
            &["profile-dsl/fetch.schema.json#/$defs/browserFetch/properties/url"]
        }
        DetectionHttpUrl => {
        ...
        DiscoveryCaptureSource => {
            &["profile-dsl/strategy.schema.json#/$defs/discoveryStrategy/properties/captures"]
        }
        DetailCaptureSource => {
            &["profile-dsl/strategy.schema.json#/$defs/detailStrategy/properties/captures"]
        }
        DiscoveryFilterOutput => &[
            "profile-dsl/strategy.schema.json#/$defs/discoveryStrategy/properties/where",
            "profile-dsl/strategy.schema.json#/$defs/discoveryStrategy/properties/extract",
        ],
        DiscoveryWhere => {
            &["profile-dsl/strategy.schema.json#/$defs/discoveryStrategy/properties/where"]
        ...
        DetailMatchFilterOutput => &[
            "profile-dsl/strategy.schema.json#/$defs/detailStrategy/properties/match",
            "profile-dsl/strategy.schema.json#/$defs/detailStrategy/properties/extract",
        ],
        DetailMatch => &[
        ...
        DetailWhere => &["profile-dsl/strategy.schema.json#/$defs/detailStrategy/properties/where"],
        DetectionHttpStatus => &[
        ...
        DiscoveryPhaseLimit => &[
            "profile-dsl/policy.schema.json#/$defs/discoveryStrategySet/properties/limits",
            "profile-dsl/policy.schema.json#/$defs/phaseLimits/properties/maxBrowserRenderedBytes",
        ],
        DetailPhaseLimit => &[
            "profile-dsl/policy.schema.json#/$defs/detailStrategySet/properties/limits",
            "profile-dsl/policy.schema.json#/$defs/phaseLimits/properties/maxBrowserRenderedBytes",
        ],
    }
}
...
fn discover_executable_roots(docs: &BTreeMap<String, Value>) -> ExecutableRoots {
    ...
    for (property, expected_target, context) in [
        (
            "discovery",
            "profile-dsl/policy.schema.json#/$defs/discoveryStrategySet",
            PrimitiveContext::Discovery,
        ),
        (
            "detail",
            "profile-dsl/policy.schema.json#/$defs/detailStrategySet",
...
fn checked_in_schemas() -> BTreeMap<String, Value> {
    [
        ...
        (
            ...
            include_str!("../../schema/profile-dsl/common.schema.json"),
        ),
        (
            "profile-dsl/diagnostics.schema.json",
            include_str!("../../schema/profile-dsl/diagnostics.schema.json"),
        ),
        (
            "profile-dsl/extract.schema.json",
            include_str!("../../schema/profile-dsl/extract.schema.json"),
        ),
        (
            "profile-dsl/fetch.schema.json",
            include_str!("../../schema/profile-dsl/fetch.schema.json"),
        ),
        (
            "profile-dsl/pagination.schema.json",
            include_str!("../../schema/profile-dsl/pagination.schema.json"),
        ),
        (
            "profile-dsl/policy.schema.json",
            include_str!("../../schema/profile-dsl/policy.schema.json"),
        ),
        (
            "profile-dsl/parse.schema.json",
            include_str!("../../schema/profile-dsl/parse.schema.json"),
        ),
        (
            "profile-dsl/predicate.schema.json",
            include_str!("../../schema/profile-dsl/predicate.schema.json"),
        ),
        (
            "profile-dsl/select.schema.json",
            include_str!("../../schema/profile-dsl/select.schema.json"),
        ),
        (
            "profile-dsl/strategy.schema.json",
            include_str!("../../schema/profile-dsl/strategy.schema.json"),
        ),
        (
            "profile-dsl/transform.schema.json",
            include_str!("../../schema/profile-dsl/transform.schema.json"),
        ),
    ]
    .into_iter()
...
fn predicate_shapes(docs: &BTreeMap<String, Value>, out: &mut Vec<SchemaShape>) {
    ...
    singleton(
        ...
        &[DetailMatch],
        AuthoredShapeKind::Tagged,
        "profile-dsl/predicate.schema.json#/$defs/equal",
    );
    singleton(
        out,
        Family::Predicate,
...
fn fetch_shapes(docs: &BTreeMap<String, Value>, out: &mut Vec<SchemaShape>) {
    ...
    let (obj, d, p) = node(docs, "profile-dsl/fetch.schema.json", "/$defs/httpFetch");
    ...
    let (fetch, fd, fp) = node(docs, "profile-dsl/fetch.schema.json", "/$defs/browserFetch");
    ...
    for root in ["browserWait", "browserInteraction"] {
        ...
        for branch in array.as_array().unwrap() {
            ...
            let (dd, pp) = split_ref("profile-dsl/fetch.schema.json", r);
...
fn pagination_shapes(docs: &BTreeMap<String, Value>, out: &mut Vec<SchemaShape>) {
    ...
    for branch in array.as_array().unwrap() {
            ...
            .filter(|v| v.as_str() != "type")
        {
            ...
            if property == "limits" {
                let (limits, ld, lp) =
                    node(docs, "profile-dsl/pagination.schema.json", "/$defs/limits");
