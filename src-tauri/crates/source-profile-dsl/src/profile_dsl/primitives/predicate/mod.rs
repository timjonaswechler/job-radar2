...
pub fn completeness_serde_shapes() -> Vec<crate::profile_dsl::primitives::completeness::SerdeShape>
{
    ...
    vec![
        serde_shape(
            ...
            Tagged,
            "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/predicate/mod.rs",
        ),
        serde_shape(
            Predicate,
            "regex",
        ...
        serde_shape(
            ...
            &[DetailMatch],
            ParentOption,
            "src-tauri/crates/source-profile-dsl/src/profile_dsl/documents/detail.rs",
        ),
        serde_shape(
            Predicate,
            "detail.match.left",
...
pub fn completeness_compiled_registrations(
    ...
    vec![
        CompiledRegistration {
            ...
            owner: P07,
            canonical_file: "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/predicate/non_empty.rs",
            shape: Tagged,
        ...
        CompiledRegistration {
            ...
            owner: P07,
            canonical_file: "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/predicate/regex.rs",
            shape: Tagged,
        ...
        CompiledRegistration {
            ...
            owner: P07,
            canonical_file: "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/predicate/equal.rs",
            shape: Tagged,
        ...
        CompiledRegistration {
            ...
            owner: P07,
            canonical_file: "src-tauri/crates/source-profile-dsl/src/profile_dsl/primitives/predicate/mod.rs",
            shape: ParentOption,
