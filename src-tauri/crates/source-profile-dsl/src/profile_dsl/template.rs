...
#[serde(transparent)]
pub struct CompiledTemplate(pub Vec<TemplateSegment>);

impl CompiledTemplate {
    pub fn references(&self, namespace: Option<&str>, key: &str) -> bool {
...
pub fn json_pointer_segment(value: &str) -> String {
...
pub fn completeness_serde_shapes() -> Vec<crate::profile_dsl::primitives::completeness::SerdeShape>
{
    ...
    vec![serde_shape(
        ...
        Keyed,
        "src-tauri/crates/source-profile-dsl/src/profile_dsl/template.rs",
    )]
}
...
pub fn completeness_compiled_registrations(
    ...
    vec![CompiledRegistration {
        ...
        owner: P01,
        canonical_file: "src-tauri/crates/source-profile-dsl/src/profile_dsl/template.rs",
        shape: Keyed,
