...
/// Minimum duration retained for deterministic Browser session teardown.
pub const BROWSER_TEARDOWN_RESERVE_MS: u64 = 2_000;
...
pub fn completeness_serde_shapes() -> Vec<crate::profile_dsl::primitives::completeness::SerdeShape>
{
    ...
    vec![serde_shape(
        ...
        ParentOption,
        "src-tauri/crates/source-profile-dsl/src/profile_dsl/documents/limits.rs",
    )]
}
...
pub fn completeness_compiled_registrations(
    ...
    vec![CompiledRegistration {
        ...
        owner: B01,
        canonical_file: "src-tauri/crates/source-profile-dsl/src/profile_dsl/documents/limits.rs",
        shape: ParentOption,
