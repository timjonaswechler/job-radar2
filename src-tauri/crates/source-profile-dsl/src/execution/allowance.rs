...
#[doc(hidden)]
pub const BROWSER_GRACEFUL_CLOSE_MS: u64 = 500;
#[doc(hidden)]
pub const BROWSER_FORCE_TERMINATE_REAP_MS: u64 = 1_000;
#[doc(hidden)]
pub const BROWSER_HANDLER_COMPLETION_MS: u64 = 250;
#[doc(hidden)]
pub const BROWSER_SESSION_FINALIZATION_MS: u64 = 250;
pub(crate) use crate::definition::documents::limits::BROWSER_TEARDOWN_RESERVE_MS;
