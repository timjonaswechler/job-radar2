...
pub(in crate::execution::detail) struct FieldEvaluation {
    pub(in crate::execution::detail) value: Option<String>,
    pub(in crate::execution::detail) failed: bool,
}

pub(in crate::execution::detail) fn evaluate_value_scalar(
...
pub(in crate::execution::detail) fn evaluate_value_list(
    document: &RuntimeItem<'_, '_>,
    source_config: &SourceConfig,
    source_name: &str,
    posting: &PostingOccurrence,
...
pub(in crate::execution::detail) fn evaluate_predicate(
    document: &RuntimeItem<'_, '_>,
    source_config: &SourceConfig,
    source_name: &str,
    posting: &PostingOccurrence,
...
pub(in crate::execution::detail) fn posting_view(
    posting: &PostingOccurrence,
) -> PostingValueView<'_> {
    PostingValueView {
...
pub(in crate::execution::detail) fn push_value_error(
