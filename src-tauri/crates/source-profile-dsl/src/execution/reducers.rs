...
use crate::{
    definition::diagnostics::{Diagnostic, DiagnosticCategory, DiagnosticSeverity, Diagnostics},
...
struct DiscoveryGroup {
    ...
    hints: BTreeMap<String, Slot<crate::execution::occurrence::DiscoveryHint>>,
...
pub(crate) fn reduce_discovery(contributions: Vec<DiscoveryContribution>) -> ReducedDiscovery {
    ...
    for (group_index, group) in groups.into_iter().enumerate() {
        ...
        let mut provider_values = crate::execution::occurrence::ProviderValues::default();
        ...
        candidates.push(PostingOccurrence {
            ...
            reference: crate::execution::occurrence::PostingReference {
                provider_url,
...
mod tests {
    use super::*;
    use crate::execution::occurrence::{DiscoveryHint, PostingReference, ProviderValues};
