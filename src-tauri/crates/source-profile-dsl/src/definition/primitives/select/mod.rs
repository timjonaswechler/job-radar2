...
use crate::definition::{documents::ParseType, primitives::parse::ParsedDocument};
...
const fn select_kind(select: &Select) -> SelectKind {
    match select {
        crate::definition::primitives::select::Select::Document(_) => SelectKind::Document,
        crate::definition::primitives::select::Select::JsonPath(_) => SelectKind::JsonPath,
        crate::definition::primitives::select::Select::XmlElement(_) => SelectKind::XmlElement,
        crate::definition::primitives::select::Select::XmlText(_) => SelectKind::XmlText,
        crate::definition::primitives::select::Select::Css(_) => SelectKind::Css,
        crate::definition::primitives::select::Select::SitemapUrls(_) => SelectKind::SitemapUrls,
    }
}
...
fn authored_select_shape(value: &Select) -> (&'static str, &'static [&'static str]) {
    match value {
        crate::definition::primitives::select::Select::Document(DocumentSelect {}) => {
            ("document", &[])
        }
        crate::definition::primitives::select::Select::JsonPath(JsonPathSelect {
            json_path: _,
        }) => ("json_path", &["jsonPath"]),
        crate::definition::primitives::select::Select::XmlElement(XmlElementSelect {
            element: _,
        }) => ("xml_element", &["element"]),
        crate::definition::primitives::select::Select::XmlText(XmlTextSelect { text_path: _ }) => {
            ("xml_text", &["textPath"])
        }
        crate::definition::primitives::select::Select::Css(CssSelect { selector: _ }) => {
            ("css", &["selector"])
        }
        crate::definition::primitives::select::Select::SitemapUrls(SitemapUrlsSelect {
            url_pattern: _,
...
pub fn completeness_serde_shapes() -> Vec<crate::definition::primitives::completeness::SerdeShape> {
    ...
    let fixtures = [
        ...
        crate::definition::primitives::select::Select::XmlText(XmlTextSelect {
            text_path: "x".into(),
        }),
        crate::definition::primitives::select::Select::Css(CssSelect {
            selector: "x".into(),
        }),
        crate::definition::primitives::select::Select::SitemapUrls(SitemapUrlsSelect {
    ...
    for value in &fixtures {
        ...
        out.push(serde_shape(
            ...
            &[Discovery, Detail],
            Tagged,
            "src-tauri/crates/source-profile-dsl/src/definition/documents/select.rs",
        ));
        for option in options {
            out.push(serde_shape(
                ...
                format!("{key}.{option}"),
                &[Discovery, Detail],
                crate::definition::primitives::completeness::AuthoredShapeKind::ParentOption,
                "src-tauri/crates/source-profile-dsl/src/definition/documents/select.rs",
            ));
        }
    }
        ...
        ($key:literal,$variant:literal,$file:literal,$witness:expr) => {
            CompiledRegistration {
                ...
                canonical_file: concat!(
                    "src-tauri/crates/source-profile-dsl/src/definition/primitives/select/",
                    $file,
                    ".rs"
                ),
                shape: Tagged,
    ...
    macro_rules! option {
        ($key:literal,$identity:literal,$file:literal,$witness:expr) => {
            CompiledRegistration {
                ...
                shape: crate::definition::primitives::completeness::AuthoredShapeKind::ParentOption,
