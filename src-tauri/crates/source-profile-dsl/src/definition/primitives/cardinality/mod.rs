...
use crate::definition::diagnostics::{Diagnostic, DiagnosticCategory, DiagnosticSeverity};
...
pub fn mismatch(expected: &'static str, actual_count: usize) -> CardinalityError {
    CardinalityError {
...
pub fn completeness_serde_shapes() -> Vec<crate::definition::primitives::completeness::SerdeShape> {
    ...
    crate::definition::primitives::cardinality::Cardinality::ALL
        .into_iter()
        .map(|value| {
            serde_shape(
                Cardinality,
        ...
        ($key:literal,$variant:literal,$file:literal,$witness:expr) => {
            CompiledRegistration {
                ...
                canonical_file: concat!(
                    "src-tauri/crates/source-profile-dsl/src/definition/primitives/cardinality/",
                    $file,
                    ".rs"
                ),
                shape: Tagged,
