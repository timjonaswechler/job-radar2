...
use crate::definition::documents::detail::{DetailExtraction, DetailStep, DetailStrategy};
    ...
    Ok(ExecutionPlanDetailStrategy {
        ...
        fetch: compile_fetch(
            ...
            match strategy.fetch {
                crate::definition::documents::Fetch::Http { .. } => {
...
fn compile_detail_extraction(
    ...
    let compile_optional = |expression: Option<
        &crate::definition::documents::extract::FieldExpression,
    >,
                            name: &str| {
        expression
