...
use crate::definition::primitives::fetch::browser::{
...
pub struct ExecutionPlanBuildError {
    pub path: String,
    pub code: &'static str,
    pub message: String,
...
pub fn compile_browser_fetch_with_descriptor(
    fetch: &Fetch,
    path: &str,
    descriptor: &crate::definition::template::TemplateDescriptor,
) -> Result<ExecutionPlanFetch, ExecutionPlanBuildError> {
    let Fetch::Browser {
        url,
        timeout_ms,
