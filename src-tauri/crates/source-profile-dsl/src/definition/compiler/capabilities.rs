...
use crate::definition::documents::{DetailStep, DiscoveryStep, Pagination, ParseType, Select};
...
fn select_syntax_member(select: &Select) -> &'static str {
    match select.kind() {
        crate::definition::primitives::select::SelectKind::Document => "type",
        crate::definition::primitives::select::SelectKind::JsonPath => "jsonPath",
        crate::definition::primitives::select::SelectKind::XmlElement => "element",
        crate::definition::primitives::select::SelectKind::XmlText => "textPath",
        crate::definition::primitives::select::SelectKind::Css => "selector",
        crate::definition::primitives::select::SelectKind::SitemapUrls => "urlPattern",
    }
}
