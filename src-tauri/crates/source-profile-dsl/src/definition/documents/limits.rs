...
pub fn completeness_serde_shapes() -> Vec<crate::definition::primitives::completeness::SerdeShape> {
    ...
    vec![serde_shape(
        ...
        ParentOption,
        "src-tauri/crates/source-profile-dsl/src/definition/documents/limits.rs",
    )]
}
...
pub fn completeness_compiled_registrations(
    ...
    vec![CompiledRegistration {
        ...
        owner: B01,
        canonical_file: "src-tauri/crates/source-profile-dsl/src/definition/documents/limits.rs",
        shape: ParentOption,
