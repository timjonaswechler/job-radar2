...
use crate::definition::primitives::{cardinality::Cardinality, transform::Transform};
...
impl FieldExpression {
    ...
    pub const fn completeness_key(&self) -> &'static str {
        match self {
            Self::Const { .. } => "const",
...
impl CombinePart {
    ...
    pub fn completeness_keys(&self) -> [&'static str; 2] {
