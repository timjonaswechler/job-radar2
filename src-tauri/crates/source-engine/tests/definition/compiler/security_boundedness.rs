...
struct TestCompileResult {
    ...
    diagnostics: source_engine::test_support::Diagnostics,
}
    ...
    fn from(outcome: CompileSourceOutcome) -> Self {
        match outcome {
            CompileSourceOutcome::Compiled {
                ...
                execution_plan: Some(source_engine::test_support::test_execution_plan(&source)),
                diagnostics,
            },
...
fn phase_limits_resolve_to_backend_ceiling_and_authored_values_can_only_tighten() {
    ...
    assert_eq!(
        ...
        source_engine::test_support::PhaseLimits::BACKEND
    );
