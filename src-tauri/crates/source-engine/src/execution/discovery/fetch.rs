...
use crate::definition::primitives::{
    fetch::http_execution::{execute_http_fetch, HttpFetchExecutionError, HttpFetchOverlay},
    ...
    match fetch {
        ExecutionPlanFetch::Http(fetch) => {
            ...
            match execute_http_fetch(
                ...
                authored_charset,
                crate::definition::primitives::fetch::http_execution::HttpStatusPolicy::RequireSuccess,
                context,
            )
            .await
            {
...
async fn fetch_browser_strategy_document(
    browser: &DiscoveryBrowserBackend<'_>,
    url: &crate::definition::template::CompiledTemplate,
    timeout_ms: u64,
    waits: &[crate::definition::execution_plan::capabilities::ExecutionPlanBrowserWait],
    interactions: &[crate::definition::execution_plan::capabilities::ExecutionPlanBrowserInteraction],
    source_config: &SourceConfig,
    source_name: &str,
    url_override: Option<&str>,
