use super::*;
use crate::definition::primitives::{
...
pub(in crate::execution::discovery) struct FieldEvaluation {
    pub(in crate::execution::discovery) value: Option<String>,
    pub(in crate::execution::discovery) failed: bool,
}

pub(in crate::execution::discovery) fn evaluate_value_scalar(
...
pub(in crate::execution::discovery) fn evaluate_value_scalar_preserving_empty(
    item: &RuntimeItem<'_, '_>,
    source_config: &SourceConfig,
    source_name: &str,
    captures: &BTreeMap<String, String>,
...
pub(in crate::execution::discovery) fn evaluate_predicate(
    item: &RuntimeItem<'_, '_>,
    source_config: &SourceConfig,
    source_name: &str,
    captures: &BTreeMap<String, String>,
...
pub(in crate::execution::discovery) fn evaluate_list_field(
    item: &RuntimeItem<'_, '_>,
    source_config: &SourceConfig,
    source_name: &str,
    captures: &BTreeMap<String, String>,
...
fn evaluate_result(
    result: Result<crate::definition::primitives::value::CompiledValueResult, ValueEvaluationError>,
    path: &str,
    strategy_key: Option<&str>,
    item_index: usize,
    diagnostics: &mut Diagnostics,
...
pub(in crate::execution::discovery) fn push_value_error(
