...
fn restore_discovery_capture_order(
    effective: &mut crate::definition::documents::DiscoveryStep,
    base: Option<&crate::definition::documents::DiscoveryStep>,
...
fn restore_detail_capture_order(
    effective: &mut crate::definition::documents::DetailStep,
    base: Option<&crate::definition::documents::DetailStep>,
            ...
            if schema.get("title").is_some() {
                diagnostics.push(compiler_error(
                    ...
                    format!(
                        ...
                        crate::definition::source_config::escape_pointer_segment(property)
                    ),
