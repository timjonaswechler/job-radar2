...
pub enum CompleteParseText {
    DecodedHttp(String),
    BrowserRendered(String),
}

impl CompleteParseText {
    pub fn as_input(&self) -> ParseInput<'_> {
        match self {
...
#[derive(Clone, Copy)]
pub struct ParseDiagnosticContext<'a> {
    pub base_path: &'a str,
...
pub fn compile_parse(
    ...
    Ok(match authored {
        crate::definition::primitives::parse::Parse::Json(authored) => {
            CompiledParse::Json(json::compile(authored, input_kind))
        }
        crate::definition::primitives::parse::Parse::Xml(authored) => {
            CompiledParse::Xml(xml::compile(authored, input_kind))
        }
        crate::definition::primitives::parse::Parse::Html(authored) => {
...
fn authored_parse_shape(value: &Parse) -> (&'static str, bool) {
    match value {
        crate::definition::primitives::parse::Parse::Json(JsonParse { charset }) => {
            ("json", charset.is_some())
        }
        crate::definition::primitives::parse::Parse::Xml(XmlParse { charset }) => {
            ("xml", charset.is_some())
        }
        crate::definition::primitives::parse::Parse::Html(HtmlParse { charset }) => {
...
pub fn completeness_serde_shapes() -> Vec<crate::definition::primitives::completeness::SerdeShape> {
    ...
    let fixtures = [
        crate::definition::primitives::parse::Parse::Json(JsonParse {
            charset: Some("utf-8".into()),
        }),
        crate::definition::primitives::parse::Parse::Xml(XmlParse {
            charset: Some("utf-8".into()),
        }),
        crate::definition::primitives::parse::Parse::Html(HtmlParse {
            charset: Some("utf-8".into()),
        }),
    ];
    let mut out = fixtures
        ...
        .map(|value| {
            ...
            serde_shape(
                ...
                &[Discovery, Detail],
                Tagged,
                "src-tauri/crates/source-engine/src/definition/documents/parse.rs",
            )
        })
        .collect::<Vec<_>>();
...
pub fn completeness_compiled_registrations(
    ...
    vec![
        CompiledRegistration {
            ...
            owner: P02,
            canonical_file:
                "src-tauri/crates/source-engine/src/definition/primitives/parse/json.rs",
            shape: Tagged,
        ...
        CompiledRegistration {
            ...
            contexts: &[Discovery, Detail],
            owner: P02,
            canonical_file: "src-tauri/crates/source-engine/src/definition/primitives/parse/xml.rs",
            shape: Tagged,
        ...
        CompiledRegistration {
            ...
            owner: P02,
            canonical_file:
                "src-tauri/crates/source-engine/src/definition/primitives/parse/html.rs",
            shape: Tagged,
        ...
        CompiledRegistration {
            ...
            contexts: &[Discovery, Detail],
            owner: P02,
            canonical_file: "src-tauri/crates/source-engine/src/definition/primitives/parse/mod.rs",
