...
Typical flow:
  ...
  scripts/development/rust-module-split.py list src-tauri/src/source_registry.rs

  # 2) Create a JSON skeleton and edit modules.todo into real groups.
  scripts/development/rust-module-split.py plan src-tauri/src/source_registry.rs > /tmp/source_registry.split.json

  # 3) Dry-run the split.
  scripts/development/rust-module-split.py split src-tauri/src/source_registry.rs \
