...
roots = ["src-tauri/src", "src-tauri/tests", "src-tauri/resources", "src", "docs"]
...
MANIFEST=${PRIMITIVE_RESIDUE_MANIFEST:-docs/agents/primitive-residue-classification.txt}
FROZEN_MANIFEST_SHA256='5a3eed44a313c866de90c4cb56de6e39c1afcde2020f2f78966e9df8cc772140'
